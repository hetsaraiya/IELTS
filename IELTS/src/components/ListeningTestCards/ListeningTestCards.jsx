...
const ListeningTestCards = () => {
   ...
   const cards = [
    {
        thumbnail: "/assets/tn1.png",
        title: "Title of lesson 1",
        qtypes: ["Matching", "Multiple Choice","Sentence Completion"]
    },
    {
        thumbnail: "/assets/tn2.png",
        title: "Title of lesson 2",
        qtypes: ["Matching"]
    },
    {
        thumbnail: "/assets/tn3.png",
        title: "Title of lesson 3",
        qtypes: ["Matching", "Multiple Choice"]
    },
    {
        thumbnail: "/assets/tn1.png",
    ...
    {
        thumbnail: "/assets/tn2.png",
        title: "Title of lesson 5",
        qtypes: ["Matching", "Multiple Choice"]
    },
    {
        thumbnail: "/assets/tn3.png",
        title: "Title of lesson 6",
        qtypes: ["Matching", "Multiple Choice"]
    },
    {
        thumbnail: "/assets/tn1.png",
        title: "Title of lesson 7",
        qtypes: ["Matching", "Multiple Choice"]
    },
    {
        thumbnail: "/assets/tn2.png",
        title: "Title of lesson 8",
        qtypes: ["Matching", "Multiple Choice"]
    },
    {
        thumbnail: "/assets/tn3.png",
        title: "Title of lesson 9",
        qtypes: ["Matching", "Multiple Choice"]
    },
    {
        thumbnail: "/assets/tn1.png",
        title: "Title of lesson 10",
        qtypes: ["Matching", "Multiple Choice"]
    },
   ]
 ...
 const [tests, setTests] = useState([]);
    ...
    useEffect(() => {
        const fetchTests = async () => {
            try {
                ...
                // const listeningTest = response.data.filter(test => test.type === 'Listening');
                // setListeningTest(listeningTest);
            } catch (err) {
  ...
  const filteredTests = tests.filter(test => test.type === 'Listening');
  ...
  return (
    <div className='font-prompt '>
      ...
      <div className='w-screen flex md:flex-row flex-col lg:mt-[100px] md:mt-[80px] mt-[40px] items-center md:items-start justify-center gap-x-[14px]'>
        ...
        <div className='w-[300px] h-[238px] bg-[#2B2D42] mb-5 md:mb-0 px-6 py-8 '>
        ...
        <div className='lg:w-[60%] md:w-[50%] w-[90%] border h-screen border-[#303030] flex flex-col items-center '>
            <p className='text-[18px] font-medium text-[#303030] lg:pt-20 pt-10'>Listening Practice Tests</p>
...
export default ListeningTestCards
